...
class IdentifiableCookie {
    ...
    static List<IdentifiableCookie> decorateAll(Collection<Cookie> cookies) throws Throwable {
        List<IdentifiableCookie> identifiableCookies = new ArrayList<IdentifiableCookie>(cookies.size());
