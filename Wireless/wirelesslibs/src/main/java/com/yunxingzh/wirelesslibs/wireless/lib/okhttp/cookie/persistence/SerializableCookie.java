...
package com.yunxingzh.wirelesslibs.wireless.lib.okhttp.cookie.persistence;
...
public class SerializableCookie implements Serializable {
    ...
    public String encode(Cookie cookie) throws Throwable {
        this.cookie = cookie;
     ...
     */
    private static String byteArrayToHexString(byte[] bytes) throws Throwable {
    ...
    public Cookie decode(String encodedCookie) throws Throwable {
     ...
     */
    private static byte[] hexStringToByteArray(String hexString) throws Throwable {
    ...
    private void writeObject(ObjectOutputStream out) throws Throwable {
